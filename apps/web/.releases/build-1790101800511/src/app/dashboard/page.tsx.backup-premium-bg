...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-full w-full bg-white p-5 md:p-8">
      <section className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        ...
        {canManageBoards ? (
          <button type="button" onClick={() => void createBoard()} className="inline-flex h-11 items-center justify-center gap-2 rounded-2xl border border-white/20 bg-white/10 px-5 text-sm font-semibold text-black shadow-lg backdrop-blur transition hover:-translate-y-0.5 hover:bg-white/20">
        ...
        {canJoinEmployee ? (
          <button
            ...
            className="inline-flex h-11 items-center justify-center gap-2 rounded-2xl bg-white px-5 text-sm font-semibold text-[#173B59] shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg"
          >
            <UserPlus size={18} />
            Join Employee
          </button>
      ...
      <section className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
        ...
        {boards
          ...
          .map((board) => (
            <div key={board.id} className="relative min-h-[170px] rounded-2xl border border-white/70 bg-white/95 p-6 shadow-lg shadow-slate-950/10 transition duration-300 hover:-translate-y-1.5 hover:border-[#D8C28E] hover:shadow-2xl">
              ...
              {canManageBoards && !board.is_system ? (
                <div className="absolute right-4 top-4 flex gap-1">
                  <button type="button" title="Edit board" onClick={() => void editBoard(board)} className="rounded-lg border bg-white p-2 text-slate-500 hover:text-[#173B59]"><Pencil size={15} /></button>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <label className="text-sm font-semibold text-slate-700">
                  ...
                  <select
                    ...
                    className="mt-2 h-11 w-full rounded-2xl border bg-white px-3 text-sm font-normal outline-none focus:border-violet-500"
                  >
