  ...
  return (
    <div className="min-h-full w-full bg-white p-5 md:p-8">
      <section className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        ...
        {canManageBoards ? (
          <button type="button" onClick={() => void createBoard()} className="inline-flex h-11 items-center justify-center gap-2 rounded-xl border border-white/20 bg-white/10 px-5 text-sm font-semibold text-white shadow-lg backdrop-blur transition hover:-translate-y-0.5 hover:bg-white/20">
        ...
        {canJoinEmployee ? (
          <button
            ...
            className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-white px-5 text-sm font-semibold text-[#173B59] shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg"
          >
            <UserPlus size={18} />
            Join Employee
          </button>
          ...
          .map((board) => (
            <div key={board.id} className="relative min-h-[170px] rounded-2xl border border-white/70 bg-white/95 p-6 shadow-lg shadow-slate-950/10 transition duration-300 hover:-translate-y-1.5 hover:border-[#D8C28E] hover:shadow-2xl">
              <Link href={`/dashboard/boards?boardId=${board.id}`} className="group block">
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-violet-50 text-[#173B59] transition group-hover:bg-violet-700 group-hover:text-white">
                  <Waypoints size={21} />
                </div>
