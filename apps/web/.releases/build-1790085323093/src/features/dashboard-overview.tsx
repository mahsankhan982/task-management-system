...
export default function DashboardOverview() {
  return (
    <div className="relative mx-auto min-h-screen max-w-[1500px] overflow-hidden bg-cover bg-center p-5 md:p-8" style={{backgroundImage:"url(/chakor-building-bg.jpg)"}}><div className="absolute inset-0 bg-black/60"></div><img src="/chakor-logo.png" className="absolute right-10 top-10 z-10 w-48 opacity-30" /><div className="relative z-20">
      <div className="mb-8">
