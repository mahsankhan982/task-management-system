...
export default function BoardsPage() {
  ...
  const displayWorkflow = useMemo(() => {
    ...
    const coreIds = new Set(
      [toDo, ...customLists, inProgress, waiting, Completed]
        .filter(Boolean)
