...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-full w-full p-5 md:p-8" style={{ background: "linear-gradient(135deg,#263B49 0%,#17364E 52%,#0E2D45 100%)" }}>
        ...
        {workspaces.map((workspace) => {
          ...
          return (
            <Link
              ...
              className="group min-h-[170px] rounded-2xl border border-white/70 bg-white/95 p-6 shadow-lg shadow-slate-950/10 transition duration-300 hover:-translate-y-1.5 hover:border-[#D8C28E] hover:shadow-2xl"
            >
              {cardContent}
            </Link>
          );
