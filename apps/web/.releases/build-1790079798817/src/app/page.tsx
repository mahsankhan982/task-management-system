...
export default function HomePage() {
  ...
  return (
    <main className="relative flex h-[100dvh] min-h-0 items-center justify-center overflow-hidden p-3 sm:p-4" style={{ background: "linear-gradient(135deg,#071A2A 0%,#0D3550 48%,#15506C 100%)" }}>
<div className="relative z-10 w-full max-w-[460px] rounded-[34px] border border-white/70 bg-white/95 p-6 shadow-[0_30px_90px_rgba(2,18,31,0.30)] backdrop-blur-xl sm:p-7">
        <ChakorLogo size={56} rounded="rounded-2xl" priority className="mx-auto mb-5 shadow-[0_12px_34px_rgba(11,35,64,0.24)]" />

        <p className="text-sm font-semibold uppercase tracking-wider text-indigo-700">
          Task Management System
        </p>

        <h1 className="mt-3 text-center text-3xl font-bold tracking-tight text-[#0A1E33]">Sign in</h1>
        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-4">
          <div>
            ...
            <input
              ...
              className="h-12 w-full rounded-xl border border-slate-300 px-4 text-sm text-slate-900 outline-none transition focus:border-[#B6934E] focus:ring-4 focus:ring-[#EADDBF]/60"
            />
          </div>
          ...
          <div>
            <div className="mb-2 flex items-center justify-between gap-3">
              ...
              <button
                type="button"
                onClick={openReset}
                className="text-sm font-semibold text-indigo-700 hover:text-blue-700"
              >
                Forgot password?
              </button>
            </div>
            <div className="relative">
              <input
                ...
                className="h-12 w-full rounded-xl border border-slate-300 px-4 pr-12 text-sm text-slate-900 outline-none transition focus:border-[#B6934E] focus:ring-4 focus:ring-[#EADDBF]/60"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={loading}
            className="h-12 w-full rounded-xl bg-gradient-to-r from-[#081A2A] via-[#0D304A] to-[#174562] text-sm font-semibold text-white shadow-lg shadow-indigo-950/20 transition hover:-translate-y-0.5 hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-60"
          >
